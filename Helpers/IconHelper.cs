...
public static class IconHelper
{
        ...
        where T : class
    {
        try
        {
            ...
            // In WinUI/UWP, BitmapImage.SetSourceAsync requires the stream to remain open for the lifetime of the BitmapImage.
            // MemoryStream over a byte array holds no unmanaged resources and is safe for GC, so we do not dispose it.
