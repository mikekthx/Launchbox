...
public static class IconHelper
{
        ...
        where T : class
    {
        try
        {
            ...
            // MemoryStream over a byte array holds no unmanaged resources.
            // It must NOT be disposed, because BitmapImage.SetSourceAsync requires
            // the stream to remain open for the lifetime of the image.
